      ...
      <div className="donation-form">
         <div className="row">
            <div className="col-lg-12">
               ...
               <p><strong>Account Number:</strong> 2090192667812</p>
               <p><strong>Account Name:</strong> THE PRIDE OF A WOMAN</p>
               <p><strong>SWIFT Code:</strong> FBLIGHAC</p>
            </div>
            <br></br><br></br>
            <div className="col-lg-12">
               <h5>Mobile Money (MoMo) Details - 1</h5>
               <p><strong>MTN Number:</strong> 0597426778</p>
               <p><strong>Account Name:</strong> The Pride Of A Woman</p>
            </div>
            ...
            {/* <div className="col-lg-12">
               ...
               <p><strong>Zelle Name:</strong> Eunice Adjei</p>
               <p><strong>Account Number:</strong> +17813011805</p>
            </div> */}
         </div>
      </div>
   );
